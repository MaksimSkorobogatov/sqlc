...
- `db_type`:
  - The PostgreSQL or MySQL type to override. Find the full list of supported types in [postgresql_type.go](https://github.com/MaksimSkorobogatov/sqlc/blob/main/internal/codegen/golang/postgresql_type.go#L12) or [mysql_type.go](https://github.com/MaksimSkorobogatov/sqlc/blob/main/internal/codegen/golang/mysql_type.go#L12).
- `go_type`:
